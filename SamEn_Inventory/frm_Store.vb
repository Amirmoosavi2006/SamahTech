...
Public Class frm_Store
    Private Sub frm_Store_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Sub Load_data()
        ...
        stroledb = "SELECT S_name AS [نام انبار], S_phone AS [شماره تماس], S_adres AS آدرس FROM tbl_Store"
        ...
        dgv_Store.DataBindings.Add(New Binding("datasource", ds, "tbl_Store"))
    ...
    Private Sub btn_save_Click(sender As Object, e As EventArgs) Handles btn_save.Click
        ...
        If txt_name.Text.Trim = "" Then
            ...
            MsgBox("نام انبار نمی تواند خالی باشد",, "انبارداری سامان")
            txt_name.Focus()
            Exit Sub
        ...
        For i = 0 To dgv_Store.Rows.Count - 1
            ...
            If txt_name.Text.Trim = dgv_Store.Item(0, i).value.tostring Then
                ...
                MsgBox("نام انبار نمی تواند تکراری باشد",, "انبارداری سامان")
        ...
        stroledb = "INSERT INTO tbl_Store (S_name, S_phone, S_adres) VALUES (@S_name, @S_phone, @S_adres)"
    ...
    Private Sub btn_edit_Click(sender As Object, e As EventArgs) Handles btn_edit.Click
        ...
        stroledb = "UPDATE tbl_Store SET S_name = @S_name, S_phone = @S_phone, S_adres = @S_adres WHERE (tbl_Store.S_name = '" & Temp_String & "')"
    ...
    Private Sub btn_del_Click(sender As Object, e As EventArgs) Handles btn_del.Click
        ...
        If Dialog_Resault = MsgBoxResult.Yes Then
            ...
            stroledb = "DELETE FROM tbl_Store WHERE (tbl_Store.S_name = '" & Temp_String & "')"
            com = New OleDbCommand(stroledb, con)
            con.Open()
            com.ExecuteNonQuery()
            con.Close()
